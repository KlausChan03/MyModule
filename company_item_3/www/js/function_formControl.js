    ...
    var uploadInst = upload.render({
      ...
      auto: true,
        ...
        layer.open({
          ...
          closeBtn: 0, //不显示关闭按钮
          content:
            '<div class="flex-hc-vc" style="width: 100%; height: 100%; padding: 0 30px; box-sizing: border-box;"><div class="layui-progress layui-progress-big" lay-showPercent="true" lay-filter="demo" style="width: 100%;"> <div class="layui-progress-bar layui-bg-green" lay-percent="0%"></div> </div></div>',
          area: ["250px", "150px"],
          success: function() {
            element.init();
          }
