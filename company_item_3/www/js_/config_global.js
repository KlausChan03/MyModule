...
require.config({
    ...
    }, _defineProperty(_paths, "global_viewFeedback", "ui/global/global_viewFeedback"), _defineProperty(_paths, "global_cloudLogin", "ui/global/global_cloudLogin"), _paths),
    map: {
        "*": {
            css: "lib/css"
        }
    ...
    }, _defineProperty(_shim, "global_viewFeedback", ["layui", "jquery", "common", "init", "func_formControl", "func_tableButton", "func_tableInit", "func_layer"]), _defineProperty(_shim, "global_cloudLogin", ["layui", "jquery", "common", "init", "func_formControl", "func_tableButton", "func_tableInit", "func_layer"]), _shim)
});